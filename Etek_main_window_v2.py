...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Check_In_Box = QtWidgets.QCheckBox(MainWindow)
        self.Check_In_Box.setGeometry(QtCore.QRect(500, 190, 70, 17))
        self.Check_In_Box.setObjectName("Check_In_Box")
        self.Check_Out_Box = QtWidgets.QCheckBox(MainWindow)
        self.Check_Out_Box.setGeometry(QtCore.QRect(600, 190, 70, 17))
